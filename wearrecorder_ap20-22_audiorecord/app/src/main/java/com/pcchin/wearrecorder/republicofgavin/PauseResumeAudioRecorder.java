package com.pcchin.wearrecorder.republicofgavin;
...
public class PauseResumeAudioRecorder {
    // Note: Files modified to make it compatible with watch

    /**
     * 6 hours, 47 minutes, and 59 seconds (1 second less than max allowed in header),
     * moved from PcmWavConverter
     */
    private static final long MAX_TIME_WAV_FILE_MILLIS=1000*24479;
    ...
    public PauseResumeAudioRecorder(){
        ...
        maxTimeInMillis=MAX_TIME_WAV_FILE_MILLIS;
        maxFileSizeInBytes=PcmWavConverter.MAX_SIZE_WAV_FILE_BYTES;
    }

    /**
     * Sets the {@link PauseResumeAudioRecorder.OnFileSizeReachedListener}
    ...
    /**
     * Sets the {@link PauseResumeAudioRecorder.OnTimeCompletionListener}. Pausing the recorder effectively will pause the timer as well.
    ...
    public void setMaxTimeInMillis(final long maxTimeInMillis){
        if (maxTimeInMillis<1000 || maxTimeInMillis>MAX_TIME_WAV_FILE_MILLIS){
