...
class PcmWavConverter {
     ...
     */
    static final long MAX_SIZE_WAV_FILE_BYTES=2L*1073741824L;
    /**
     *
    ...
    static void convertPCMToWav(WaveHeader waveHeader, final String pcmFilePath, final String wavFilePath)throws IOException{
        if (waveHeader ==null){
    ...
    private static void writePCMData(final DataOutputStream out, @NotNull final DataInputStream in)throws IOException{
    ...
    public static class WaveHeader{
         ...
         */
        WaveHeader(final int sampleRateInHertz, final short channelNum, final short bitRate){
         ...
         * @throws IllegalArgumentException If any parameters are invalid.
         */
        WaveHeader(final int sampleRateInHertz, final short channelNum, final short bitRate, final int byteNumber){
